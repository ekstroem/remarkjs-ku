...
output:
  xaringan::moon_reader:
    lib_dir: libs
    css: ['default', 'ku.css', 'hygge', 'animate.min.css', 'printable.css']
    seal: true
    nature:
      ratio: '16:9'
...
```{r dia1, echo=FALSE, out.width=960, out.height=300}
library(DiagrammeR)
grViz("
  digraph {
    bgcolor = 'transparent'
...
```{r dia2, echo=FALSE, out.width=960, out.height=100}
library(DiagrammeR)
mermaid("
graph LR
  A-->B
...
p <- p +
  theme(
    text=element_text(size=20, family="Anime Ace 2.0 BB")
    , panel.background = element_rect(fill = "#222222") # bg of the panel
    , plot.background = element_rect(fill = "#222222") # bg of the plot
    , axis.line = element_line(size=2, colour="#ffffff")
