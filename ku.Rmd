---
title: "The mathematics of over diagnosis"
subtitle: 'Subtitle'
author: "Claus Thorn Ekstrøm<br>UCPH Biostatistics<br>.small[ekstrom@sund.ku.dk ]"
date: 'Some day 2019, January 30th<br>`r fontawesome::fa("twitter", fill = "steelblue")` @ClausEkstrom <br> .small[Slides: [biostatistics.dk/talks/](www.biostatistics.dk/talks/)]'
output:
...
`r fontawesome::fa("twitter", fill = "steelblue")` @ClausEkstrom
